		...
		AGILITY(3032, 3034, 3036, 3038), ANTI_VENOM(12905, 12907, 12909, 12911), ANTI_VENOM_PLUS(12913, 12915, 12917, 12919), ANTIDOTE_PLUS(5943, 5945, 5947,
				5949), ANTIDOTE_PLUS_PLUS(5952, 5954, 5956, 5958), ANTIFIRE(2452, 2454, 2456, 2458), ANTIPOISON(2446, 175, 177, 179), ATTACK(2428, 121, 123, 125), COMBAT(9739,
						9741, 9743, 9745), DEFENCE(2432, 133, 135, 137), ENERGY(3008, 3010, 3012, 3014), FISHING(2438, 151, 153, 155), MAGIC(3040, 3042, 3044,
								3046), OVERLOAD(11730, 11731, 11732, 11733), OVERLOAD_raids(20992, 20991, 20990, 20989), PRAYER(2434, 139, 141, 143), RANGING(2444, 169, 171, 173), RESTORE(2430, 127, 129,
										131), SARADOMIN_BREW(6685, 6687, 6689, 6691), STRENGTH(113, 115, 117, 119), SUPER_ANTIPOISON(2448, 181, 183, 185), SUPER_ATTACK(2436, 145,
												147, 149), SUPER_COMBAT(12695, 12697, 12699, 12701), Elder_potion(20920, 20919, 20918, 20917), Kodai_potion(20944, 20943, 20942, 20941), Twisted_potion(20932, 20931, 20930, 20929), Revitalisation_potion(20956, 20955, 20954, 20953),SUPER_DEFENCE(2442, 163, 165, 167), SUPER_ENERGY(3016, 3018, 3020,
														3022), SUPER_RESTORE(3024, 3026, 3028, 3030), Xeric_aid(20980, 20979, 20978, 20977), SUPER_STRENGTH(2440, 157, 159, 161), ZAMORAK_BREW(2450, 189, 191, 193);
