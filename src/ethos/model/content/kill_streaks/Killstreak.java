...
import ethos.Server;
import ethos.model.content.RandomLoot;
		...
		ROGUE(10, new KillstreakReward(2) {
			...
			public void append(Player player) {
				if (player.inClanWars() || player.inClanWarsSafe()) {
					...
					player.privateBounty = (player.hasReached5Killstreak ? 10000000 : 5000000);
					player.getPA().yell(player.getName() + " is on a killstreak of " +player.killStreak + " " + (player.hasReached5Killstreak ? "slay" : "kill") + " him for " + player.privateBounty + " coins");
					if (!player.hasReached5Killstreak)
					player.hasReached5Killstreak = true;
				} 
			}
			...
			public void append(Player player) {
				if (player.inClanWars() || player.inClanWarsSafe()) {
					...
					player.privateBounty = (player.hasReached6Killstreak ? Misc.random(player.privateBounty, 15000000) : Misc.random(player.privateBounty, 5000000));
					player.getPA().yell(player.getName() + " is on a killstreak of " +player.killStreak + " " + (player.hasReached6Killstreak ? "brutalize" : "stop") + " him for " + player.privateBounty + " coins");
					player.getRandomLoot().open();
					if (!player.hasReached6Killstreak)
					player.hasReached6Killstreak = true;
				}
			...
			public void append(Player player) {
				if (player.inClanWars() || player.inClanWarsSafe()) {
					...
					player.privateBounty = (player.hasReached7Killstreak ? Misc.random(player.privateBounty, 15000000) : Misc.random(player.privateBounty, 5000000));
					player.getPA().yell(player.getName() + " is on a killstreak of " +player.killStreak + " " + (player.hasReached7Killstreak ? "smack" : "drop") + " him for " + player.privateBounty + " coins");
					player.getRandomLoot().open();
					if (!player.hasReached7Killstreak)
					player.hasReached7Killstreak = true;
			...
			public void append(Player player) {
				if (player.inClanWars() || player.inClanWarsSafe()) {
					...
					player.privateBounty = (player.hasReached8Killstreak ? Misc.random(player.privateBounty, 15000000) : Misc.random(player.privateBounty, 5000000));
					player.getPA().yell(player.getName() + " is on a killstreak of " +player.killStreak + " " + (player.hasReached8Killstreak ? "smack" : "drop") + " him for " + player.privateBounty + " coins");
					 
					if (!player.hasReached8Killstreak)
					player.hasReached8Killstreak = true;
				} 
			}
			...
			public void append(Player player) {
				if (player.inClanWars() || player.inClanWarsSafe()) {
					...
					player.privateBounty = (player.hasReached9Killstreak ? Misc.random(player.privateBounty, 15000000) : Misc.random(player.privateBounty, 5000000));
					player.getPA().yell(player.getName() + " is on a killstreak of " +player.killStreak + " " + (player.hasReached9Killstreak ? "smack" : "drop") + " him for " + player.privateBounty + " coins");
					player.getRandomLoot().open();
					if (!player.hasReached9Killstreak)
					player.hasReached9Killstreak = true;
				} 
			}
			...
			public void append(Player player) {
				if (player.inClanWars() || player.inClanWarsSafe()) {
					...
					player.privateBounty = (player.hasReached10Killstreak ? Misc.random(player.privateBounty, 15000000) : Misc.random(player.privateBounty, 5000000));
					player.getPA().yell(player.getName() + " is on a killstreak of " +player.killStreak + " " + (player.hasReached10Killstreak ? "smack" : "drop") + " him for " + player.privateBounty + " coins");
					player.getRandomLoot().open();
					if (!player.hasReached10Killstreak)
					player.hasReached10Killstreak = true;
				} 
			}
