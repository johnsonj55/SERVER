...
public class Item {
	 ...
	 * Server glove IDs.
	 */
	public static int gloves[] = { 21817, 21816, 7595, 6629, 8021, 8016, 7964, 2491, 1065, 2487, 2489, 3060, 1495, 775, 777, 778,
	 ...
	 * Server hat IDs.
	 */
	public static int hats[] = { 749, 3057, 20838, 24271, 2679, 2685, 2682, 2703, 2688, 2691, 2691, 2733, 2736, 2718, 2730, 2697, 2715,
	...
	public static int amulets[] = { 1654, 1656, 1658, 1660, 1662, 1664, 8081, 8033, 7968, 6585, 86, 87, 295, 421, 552,
			...
			10360, 10361, 10362, 10363, 10364, 10365, 10366, 10367, 12851, 12852, 12853, 22986 };
	 ...
	 * Server ring IDs.
	 */
	public static int rings[] = { 30626, 8082, 773, 1635, 1637, 1639, 1641, 1643, 1645, 2550, 2552, 2554, 2556, 2558, 2560,
	...
	public static boolean isFullBody(int itemId) {
		...
		switch (itemId) {
			...
			case 577:
			case 581:
			case 15034://custom spectre body
			case 15044://custom spectral body
			case 22641:
			case 22695:
	...
	static {
		try {
			...
			for (String data : stackableData) {
				...
				itemStackable[23083] = true;
				itemStackable[6646] = true;
				itemStackable[6651] = true;
				itemStackable[21930] = true;
				itemStackable[21207] = true;
				itemStackable[22804] = true;
				itemStackable[23083] = true;
				itemStackable[32950] = true;
			} 
		} catch (IOException e) {
			e.printStackTrace();
		}
