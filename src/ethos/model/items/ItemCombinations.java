...
import ethos.model.items.item_combinations.AmuletOfTorture;
import ethos.model.items.item_combinations.ArcaneSpiritShield;
//import ethos.model.items.item_combinations.ArmadylGodsword;
import ethos.model.items.item_combinations.BalanceBook;
//import ethos.model.items.item_combinations.BandosGodsword;
import ethos.model.items.item_combinations.BlessedSpiritShield;
import ethos.model.items.item_combinations.BlueDarkBow;
//import ethos.model.items.item_combinations.BonecrusherNecklace;
//import ethos.model.items.item_combinations.BrimstoneRing;
//import ethos.model.items.item_combinations.DevoutBoots;
import ethos.model.items.item_combinations.DragonDefender;
//import ethos.model.items.item_combinations.DragonHunterLance;
...
//import ethos.model.items.item_combinations.NecklaceOfAnguish;
//import ethos.model.items.item_combinations.OccultNecklace;
...
//import ethos.model.items.item_combinations.SaradominGodsword;
...
//import ethos.model.items.item_combinations.ZamorakGodsword;
...
/*
	DEVOUT_BOOTS(new DevoutBoots(new GameItem(22954), Optional.empty(), new GameItem[] { new GameItem(12958), new GameItem(22960) })),

	BRIMSTONE_RING(new BrimstoneRing(new GameItem(22975), Optional.empty(), new GameItem[] { new GameItem(22969), new GameItem(22971), new GameItem(22973) })),
	
	BOOTS_OF_BRIMSTONE(new DevoutBoots(new GameItem(22951), Optional.empty(), new GameItem[] { new GameItem(23037), new GameItem(22957) })),
	
	BONECRUSHER_NECKLACE(new BonecrusherNecklace(new GameItem(22986), Optional.empty(), new GameItem[] { new GameItem(13116), new GameItem(22111), new GameItem(22988) })),

	DRAGON_HUNTER_LANCE(new DragonHunterLance(new GameItem(22978), Optional.empty(), new GameItem[] { new GameItem(11889), new GameItem(22966) })),

	BANDOS_GODSWORD(new BandosGodsword(new GameItem(20370), Optional.empty(), new GameItem[] { new GameItem(11804), new GameItem(20071) })),

	ARMADYL_GODSWORD(new ArmadylGodsword(new GameItem(20368), Optional.empty(), new GameItem[] { new GameItem(11802), new GameItem(20068) })),

	ZAMORAK_GODSWORD(new ZamorakGodsword(new GameItem(20374), Optional.empty(), new GameItem[] { new GameItem(11808), new GameItem(20077) })),

	SARADOMIN_GODSWORD(new SaradominGodsword(new GameItem(20372), Optional.empty(), new GameItem[] { new GameItem(11806), new GameItem(20074) })),
	
	NECKLACE_OF_ANGUISH(new NecklaceOfAnguish(new GameItem(22249), Optional.empty(), new GameItem[] { new GameItem(19547), new GameItem(22246) })),
	
	AMULET_OF_TORTURE(new AmuletOfTorture(new GameItem(20366), Optional.empty(), new GameItem[] { new GameItem(19553), new GameItem(20062) })),

	OCCULT_NECKLACE(new OccultNecklace(new GameItem(19720), Optional.empty(), new GameItem[] { new GameItem(12002), new GameItem(20065) })),
	*/
