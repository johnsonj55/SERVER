...
public class AmuletOfTorture extends ItemCombination {
	...
	public AmuletOfTorture(GameItem outcome, Optional<List<GameItem>> revertedItems, GameItem[] items) {
	...
	public void combine(Player player) {
		...
		player.getDH().sendItemStatement("You combined the items and created the Amulet of Fury (or).", 20366);
