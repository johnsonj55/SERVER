...
public class AttackAnimation extends NPCHandler {
    ...
    private static int attackAnimNumber = 0;
...
//		case 8361://the maiden of sugadinti
//			return 8092; 
	...
	/*	case 8388://Sotetseg
		...
		case 8611:
			return npcs[i].attackType == CombatType.MELEE ? 8270 : 8271;
		case 8612:
			return npcs[i].attackType == CombatType.MELEE ? 8275 : 8276;
		case 8614:
			return 8283;
		case 8615:
			return attackAnimNumber = npcs[i].attackType == CombatType.RANGE ? 8263 : npcs[i].attackType == CombatType.MAGE ? 8264 : 8265;
		case 8619:
			return attackAnimNumber = npcs[i].attackType == CombatType.RANGE ? 8241 : npcs[i].attackType == CombatType.MAGE ? 8242 : 8243;
		case 8620:
			return attackAnimNumber = npcs[i].attackType == CombatType.RANGE ? 8248 : npcs[i].attackType == CombatType.MAGE ? 8249 : 8250;
		case 8621:
			return attackAnimNumber = npcs[i].attackType == CombatType.RANGE ? 8255 : npcs[i].attackType == CombatType.MAGE ? 8255 : 8256;
