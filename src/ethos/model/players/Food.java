...
public class Food {
	...
	public static enum FoodToEat {
		...
		GUANIC_BAT(20871, 5, "Guanic bat (0)", 0, "Food", false), 
		PRAEL_BAT(20873, 8, "Prael bat (1)", 0, "Food", false), 
		Giral_bat(20875, 11, "Giral bat (2)", 0, "Food", false), 
		Phluxi_bat(20877, 14, "Phluxia bat (3)", 0, "Food", false), 
		Kryket_bat(20879, 17, "Kryket bat (4)", 0, "Food", false), 
		Murng_bat(20881, 20, "Murng bat (5)", 0, "Food", false),
		Psykk_bat(20883, 23, "Psykk bat (6)", 0, "Food", false), 
		Pysk_fish(20856, 5, "Pysk fish (0)", 0, "Food", false), 
		Suphi_fish(20858, 8, "Suphi fish (1)", 0, "Food", false),
		Leckish_fish(20860, 11, "Leckish fish (2)", 0, "Food", false), 
		Brawk_fish(20862, 14, "Brawk fish (3)", 0, "Food", false), 
		Mycil_fish(20864, 17, "Mycil fish (4)", 0, "Food", false), 
		Roqed_fish(20866, 20, "Roqed fish (5)", 0, "Food", false), 
		Kyren_fish(20868, 23, "Kyren fish (6)", 0, "Food", false), 
