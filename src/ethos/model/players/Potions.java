	...
	public void handlePotion(int itemId, int slot) {
		...
		if (c.potionTimer.elapsed() > 1200) {
			...
			case 12701:
				...
				break;
			case 20920:
				drinkStatPotion(itemId, 20919, slot, 0, true); // Elder potion
				enchanceStat(1, true);
				enchanceStat(2, true);
				break;
			case 20919:
				drinkStatPotion(itemId, 20918, slot, 0, true); 
				enchanceStat(1, true);
				enchanceStat(2, true);
				break;
			case 20918:
				drinkStatPotion(itemId, 20917, slot, 0, true); 
				enchanceStat(1, true);
				enchanceStat(2, true);
				break;
			case 20917:
				...
				break;
			case 20944:
				drinkStatPotion(itemId, 20943, slot, 0, true); // Kodai_potion
				enchanceStat(1, true);
				enchanceStat(2, true);
				break;
			case 20943:
				drinkStatPotion(itemId, 20942, slot, 0, true); 
				enchanceStat(1, true);
				enchanceStat(2, true);
				break;
			case 20942:
				drinkStatPotion(itemId, 20941, slot, 0, true); 
				enchanceStat(1, true);
				enchanceStat(2, true);
				break;
			case 20941:
				...
				break;
			case 20932:
				drinkStatPotion(itemId, 20931, slot, 0, true); // Twisted_potion
				enchanceStat(1, true);
				enchanceStat(2, true);
				break;
			case 20931:
				drinkStatPotion(itemId, 20930, slot, 0, true); 
				enchanceStat(1, true);
				enchanceStat(2, true);
				break;
			case 20930:
				drinkStatPotion(itemId, 20929, slot, 0, true); 
				enchanceStat(1, true);
				enchanceStat(2, true);
				break;
			case 20929:
				...
				break;
			case 20956:
				drinkStatPotion(itemId, 20955, slot, 0, true); // Revitalisation_potion
				enchanceStat(1, true);
				enchanceStat(2, true);
				break;
			case 20955:
				drinkStatPotion(itemId, 20954, slot, 0, true); 
				enchanceStat(1, true);
				enchanceStat(2, true);
				break;
			case 20954:
				drinkStatPotion(itemId, 20953, slot, 0, true); 
				enchanceStat(1, true);
				enchanceStat(2, true);
				break;
			case 20953:
				...
				break;
			case 20980:
				drinkStatPotion(itemId, 20979, slot, 0, true); // xeric's aid
				enchanceStat(1, true);
				enchanceStat(2, true);
				break;
			case 20979:
				drinkStatPotion(itemId, 20978, slot, 0, true); 
				enchanceStat(1, true);
				enchanceStat(2, true);
				break;
			case 20978:
				drinkStatPotion(itemId, 20977, slot, 0, true); 
				enchanceStat(1, true);
				enchanceStat(2, true);
				break;
			case 20977:
