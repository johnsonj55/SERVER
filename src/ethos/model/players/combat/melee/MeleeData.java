...
public class MeleeData {
	...
	public static void getPlayerAnimIndex(Player c, String weaponName) {
		...
		if (weaponName.contains("@yel@Ring of Flying")) {
		...
		if (weaponName.contains("2h sword") || weaponName.contains("godsword") || weaponName.contains("saradomin sw") || weaponName.contains("anger") || weaponName.contains("saradomin's bless") || weaponName.contains("large spade")) {
			if (c.playerEquipment[c.playerWeapon] != 7158 && c.playerEquipment[c.playerWeapon] != 7807 && c.playerEquipment[c.playerWeapon] != 7808 && c.playerEquipment[c.playerWeapon] != 22630 ) {
	...
	public static int getWepAnim(Player c, String weaponName) {
		...
		if (weaponName.contains("sword") || weaponName.contains("scimitar") || weaponName.contains("rapier") && !weaponName.contains("training")) {
			return 412;
		}
		if (weaponName.contains("karil")) {
			return 2075;
	...
	public static int getBlockEmote(Player c) {
		...
		if (shield.contains("2h") && c.playerEquipment[c.playerWeapon] != 7158)
			return 7050;
		if (shield.contains("anger") && c.playerEquipment[c.playerWeapon] != 7807)
			return 7050;
		if (shield.contains("throne") && c.playerEquipment[c.playerWeapon] != 22630)
			return 7050;
		if (shield.contains("anger") && c.playerEquipment[c.playerWeapon] != 7808)
			return 7050;
