...
public class MeleeSpecial {
	...
	public static void activateSpecial(Player c, int weapon, int i) {
		 ...
		 * 
		 * case 22631: //KORASI c.gfx100(1224); c.startAnimation(1872); c.specAccuracy = 5.00; c.specDamage = 2.00; c.ssSpec = true;
		 * c.hitDelay = getHitDelay(c.getItems().getItemName(c.playerEquipment[c.playerWeapon]).toLowerCase()); break;
		 * 
