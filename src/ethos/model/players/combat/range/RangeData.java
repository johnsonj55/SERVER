...
//				// JAVELINS
	...
	public static int getRangeProjectileGFX(Player c) {
		...
		if (c.playerEquipment[c.playerWeapon] == 9185 || c.playerEquipment[c.playerWeapon] == 11785 || c.playerEquipment[c.playerWeapon] == 21012 || c.playerEquipment[c.playerWeapon] == 21902)
			return 27;
		int str = -1;
		...
		int[][] data = {
				// KNIFES
				{ 863, 213 }, { 864, 212 }, { 865, 214 }, { 866, 216 }, { 867, 217 }, { 868, 218 }, { 22804, 1622 }, { 869, 215 },
