...
public class VolatileStaff extends Special {

	public VolatileStaff() {
		super(5.0, 2.10, 1.30, new int[] { 24424 }); 
	}
...
//		target.addDamageTaken(target, Misc.random(25)); //25
	...
	public void hit(Player player, Entity target, Damage damage) {
		System.out.println("hit " + target.getName());
	}
