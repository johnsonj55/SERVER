...
public abstract class Mode {
	...
	private static final List<Mode> MODES = ImmutableList
			.copyOf(Arrays.asList(new RegularMode(ModeType.REGULAR), new IronmanMode(ModeType.IRON_MAN), new UltimateIronmanMode(ModeType.ULTIMATE_IRON_MAN), new OsrsMode(ModeType.OSRS), new GroupIronman(ModeType.GROUP_IRONMAN)));
