	...
	public void processPacket(final Player c, int packetType, int packetSize) {
		...
		case FIRST_CLICK:
			...
			case 11701:
				...
				break;
			case 9398:// deposit
				c.getPA().sendFrame126("The Bank of Mistex - Deposit Box", 7421);
			...
			case 32215:
				...
				if (c.playerLevel[13] < 90) {
					c.sendMessage("You must have a magic and runecrafting level of at least 60 to do this.");
					return;
				}
					if (c.getItems().playerHasItem(3140, 1) && c.getItems().playerHasItem(22103, 1) && c.getItems().playerHasItem(22097, 1) ) {
						c.getItems().deleteItem(3140, 1);
						c.getItems().deleteItem(22103, 1);
						c.getItems().deleteItem(22097, 1);
						c.getItems().addItem(21892, 1);
						c.startAnimation(6929);
						c.getDH().sendItemStatement("You combined the items and created a @red@Dragon platebody@red@.", 21892);
						c.sendMessage("You combine the items and created a @red@Dragon platebody@red@.");
					} else {
