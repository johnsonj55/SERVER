...
import ethos.model.content.TeleportTab;
...
public class ClickingButtons implements PacketType {
	...
	public void processPacket(final Player c, int packetType, int packetSize) {
		...
		if (c.collectionLog.clickButton(actionButtonId))
			return;
		if (c.presetManager.clickButton(actionButtonId))
			return;
		...
		if (TeleportTab.handleButtons(c, actionButtonId)) {
			return;
		}
...
//			c.setSidebarInterface(2, 29465);
		...
		case 40168:
			...
			if(c.questTab == 2) {
				c.getPA().sendFrame126("http://YOURLINKHERE.com/forums/forumdisplay.php?fid=9", 12000);
			}
			if(c.questTab == 3) {
	...
	//	case 40174:
		case 115036:
			c.setSidebarInterface(2, 47500); // 638
			break;
		case 23132:
		 ...
		 */
		// break;
		case 10410://Cooks assistant
			c.getCooksAssistant().display(c);
			break;
		case 10411://Dorics Quest
			c.getDoricsQuest().display(c);
			break;
		case 10413://Monkey Madness
			c.getMonkeyMadness().display(c);
			break;
		case 10412://Murder Mystery
			c.getMurderMystery().display(c);
			break;
//		case 10414://Dragon Slayer 2
//			c.getDragonSlayer2().display(c);
//			break;
		case 114121:
			c.getDiaryManager().getVarrockDiary().display();
			break;
		...
		case 39241:
			...
			c.forcedChat("I've played Scapeplay for a total of : " + time);
			break;
		case 113240:
		...
		case 185156: // Store
			...
			case 185157: // Store
				...
				break;
			case 185158: // Store
				c.getPA().sendFrame126("Mistex", 12000);
				//c.getPA().sendFrame126("https://OSPSrs.com/store", 12000);
				// https://www.youtube.com/user/DopeRsps/videos
				break;
			case 185142:
		...
		case 75010:
			...
			c.getPA().spellTeleport(3085, 3493, 0, true);
