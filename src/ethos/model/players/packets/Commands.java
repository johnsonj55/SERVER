...
public class Commands implements PacketType {
    ...
    public void processPacket(Player c, int packetType, int packetSize) {
        ...
        if (playerCommand.startsWith("discord")) {
        	c.getPA().sendString("https://discord.gg/Q93zbgHQf6", 12000);
        }
        ...
        if (playerCommand.startsWith("highscores")) {
            ...
            c.sendMessage("Not yet available");
        }
        if (playerCommand.startsWith("vote")) {

            c.getPA()
                    .sendFrame126(
                            "http://mistex.live/vote", 12000);
        }
        if (playerCommand.startsWith("donate")) {

            c.getPA()
                    .sendFrame126(
                            "http://mistex.live/donate/", 12000);
        }
        ...
        if (playerCommand.startsWith("spawns") && c.playerName.equals("josh") ) {
        ...
        if (playerCommand.startsWith("claimvotes")) {
        	new Votes(c);
        }
