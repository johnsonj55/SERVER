...
public class FiveOptions {
	...
	public static void handleOption1(Player c) {
		...
		if (c.dialogueAction == 540) {
			c.getFightCave().create(4);
			return;
		}
		if (c.teleAction == 17) {
	...
	case 193193:
		...
		if (c.dialogueAction == 541) {
			c.getDH().sendDialogues(633, 2461);
			return;
		}
		
		if (c.dialogueAction == 542) {
			c.getDH().sendDialogues(5440, 2462);
			return;
		}
	...
	public static void handleOption5(Player c) {
		...
		switch (c.dialogueAction) {
		case 711:
			c.getDH().sendDialogues(99999, 1909);
			break;
		case 77:
		case 801:
		case 851:
