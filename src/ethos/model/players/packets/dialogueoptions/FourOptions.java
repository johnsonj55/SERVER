...
public class FourOptions {
	...
	public static void handleOption1(Player c) {
		...
		case 1501://Cooks Assistant
			c.getDH().sendDialogues(1502, 4626);
		break;
		case 1508://Cooks Assistant
			c.getDH().sendDialogues(1509, 4626);
		break;
		case 1460://Murder Mystery
			c.getDH().sendDialogues(1461, 4218);
