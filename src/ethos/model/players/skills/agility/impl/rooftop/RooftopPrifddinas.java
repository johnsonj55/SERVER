...
public class RooftopPrifddinas {
	...
	public static final int LEADDER = 36221, 
	...
	public static int[] PRIFDDINAS_OBJECTS = { LEADDER, CLOTHES_LINE, LEAP_GAP, BALANCE_WALL_JUMP, LEAP_2ND_GAP, LEAP_3RD_GAP, LEAP_4TH_GAP, HURDLE_LEDGE, JUMP_OFF_EDGE };

	public boolean execute(final Player c, final int objectId) {
		
		for (int id : PRIFDDINAS_OBJECTS) {
		...
		switch (objectId) {
		case LEADDER:
			AgilityHandler.delayEmote(c, "CLIMB_UP_EMOTE", 3255, 6109, 3, 2);
