...
public enum Potion {
	...
	Elder_potion(new GameItem(20920), 90, 150, new GameItem(269), new GameItem(2436), new GameItem(2440), new GameItem(2442)), 
	Kodai_potion(new GameItem(20944), 76, 172, new GameItem(2481), new GameItem(3138)),
	Twisted_potion(new GameItem(20932), 72, 162, new GameItem(267), new GameItem(245)), 
	Revitalisation_potion(new GameItem(20956), 63, 142, new GameItem(3000), new GameItem(223)), 
	Xeric_aid(new GameItem(20980), 81, 180, new GameItem(2998), new GameItem(6693)), 
