...
import ethos.model.area.RegionBasedArea;
...
public class Task {
	...
	/**
	 * The optional area the task must be done in
	 */
	private RegionBasedArea area;
	...
	/**
	 * The optional area the task must be completed in
	 * @return A RegionBasedArea that contains an array of region IDs
	 */
	public RegionBasedArea getArea() {
		return area;
	}
